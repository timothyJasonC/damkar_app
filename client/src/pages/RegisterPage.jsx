...
export default function RegisterPage() {
    ...
    async function handleRegisterAdmin(ev) {
        ev.preventDefault()
        const response = await fetch('http://localhost/damkar/api/register_admin.php', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
        ...
        <div className="mt-4 grow flex items-center justify-center">
            <div className="mb-64">
                ...
                <form className="max-w-md mx-auto" >
                    ...
                    <button className="primary" onClick={handleRegisterAdmin}>Register as Admin</button>
                    <div className="text-center py-2 text-gray-500">
                        Already a member?
